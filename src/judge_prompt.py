...
def build_judge_prompt(
    ...
    *,
    ...
    """Build the category-specific prompt from LongMemEval evaluate_qa.py."""
    ...
    return JudgePrompt(question_id, "", template.format(question, reference_answer, hypothesis),
                       "yes or no", PROMPT_VERSION)
